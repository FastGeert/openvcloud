def main(j, args, params, tags, tasklet):
    ...
    vmcl = j.clients.osis.getCategory(
        j.core.portal.active.osis, "cloudbroker", "vmachine"
    )
    stackcl = j.clients.osis.getCategory(
        j.core.portal.active.osis, "cloudbroker", "stack"
    )
    imgcl = j.clients.osis.getCategory(
        j.core.portal.active.osis, "cloudbroker", "image"
    )
