...
class KnowledgeBase(Framework):
    ...
    def test01_technical_tutorials(self):
        ...
        **Test Scenario:**
        ...
        self.assertEqual(
            self.get_text("knowledge_base_header_label"), "Technical Tutorials"
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab"),
            "Access your Cloud Space using OpenVPN",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab"),
            "How to configure Ubuntu to connect to OpenVPN",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab"), "My First Machine Linux"
        )
        self.assertEqual(
            self.get_text("knowledge_base_line4_tab"),
            "Enable Root access on ubuntu over SSH",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab"), "My First Machine Windows"
        )
        self.assertEqual(
            self.get_text("knowledge_base_line6_tab"),
            "PPTP Connection To Space From Windows 10",
        )
        self.assertEqual(self.get_text("knowledge_base_line7_tab"), "Using the API")
        self.assertEqual(self.get_text("knowledge_base_subheader_label"), "Welcome")
        self.assertEqual(
            self.get_text("knowledge_base_subheader_email"), "support@greenitglobe.com"
        )
        self.assertEqual(
            self.get_text("knowledge_base_subheader_text"),
    ...
    def test02_technical_tutorials_first_tab(self):
        ...
        **Test Scenario:**
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_header"),
            "Access your Cloud Space using OpenVPN",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line1"),
            "Go to: OpenVPN Downloads Page.",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line2"),
            'Choose your installer according to your architect "Windows Installer '
            '(32-bit)|Windows Installer (64-bit)".',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line3"),
            'Right-click on the installer and choose: "Run as administrator"',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line4"),
            'Press "Yes" in the confirmation windows',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line5"),
            'Click "Next" on the welcome page',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line6"),
            'Click "I Agree" on the license page',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line7"),
            'Click "Next" for the default components',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line8"), 'Click "Install"'
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line9"),
            'Click "Next" after the installation in completed',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line10"),
            "Download our OpenVPN configuration zip from the Network Deck",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line11"),
            'Unzip the "OpenVPN configuration zip" at: "C:Program Files'
            'OpenVPNconfig"',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line1_tab_line12"),
    ...
    def test03_technical_tutorials_second_tab(self):
        ...
        **Test Scenario:**
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_header"),
            "How to configure Ubuntu to connect to OpenVPN",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line1"),
            "Open Terminal\nIn Unity\nDash -> Search for Terminal\nIn Gnome\n"
            "Application menu -> Accessories -> Terminal\nor\n"
            "Keyboard Shortcut: Ctrl + Alt + T",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line2"),
            "Run the following command apt-get install network-manager-openvpn",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line3"),
            "Right-click on the network icon on the system tray",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line4"),
            'Choose: "Edit Connections"',
        )
        self.assertEqual(self.get_text("knowledge_base_line2_tab_line5"), "Click Add")
        self.assertTrue(self.wait_element("knowledge_base_line2_tab_image5"))
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line6"),
            "Choose Connection Type : openvpn",
        )
        self.assertTrue(self.wait_element("knowledge_base_line2_tab_image6"))
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line7"),
            "The following window will open:",
        )
        self.assertTrue(self.wait_element("knowledge_base_line2_tab_image7"))
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line7_sub1"),
            'Enter the connection name as example "VPN connection"',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line7_sub2"), "Enter the Gateway"
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line7_sub3"),
            "Under the Authentication -> Type -> choose Passowrd",
        )
        self.assertTrue(self.wait_element("knowledge_base_line2_tab_line7_image3"))
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line7_sub4"),
            "Download our CA certificate",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line7_sub5"),
            "Enter the username and the passowrd",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line7_sub6"),
            "Import the CA certificate you just downloaded",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line8"),
            'Click "Advanced" the following window will open:',
        )
        self.assertTrue(self.wait_element("knowledge_base_line2_tab_image8"))
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line8_sub1"),
            'Set "Use Custom gateway port " to 999',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line8_sub2"),
            'Mark "Use a TCP connection"',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line8_sub3"),
            'Click "OK" and then Save',
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line9"),
            "Right-click on the network icon on the system tray",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line2_tab_line10"),
    ...
    def test04_technical_tutorials_third_tab(self):
        ...
        **Test Scenario:**
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_header"), "My First Machine Linux"
        )
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line1"),
            "Login to the OpenvCloud User Portal:",
        )
        self.assertTrue(self.wait_element("knowledge_base_line3_tab_image1"))
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line2"),
            "To create a virtual machine go to Machines, and click on"
            " 'Create Machine'",
        )
        self.assertTrue(self.wait_element("knowledge_base_line3_tab_image2"))
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line3"),
            "Select your properties in this example:",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line3_sub1"), "Ubuntu 14.04 64 bit"
        )
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line3_sub2"), "1 GB memory"
        )
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line3_sub3"), "Std disk size"
        )
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line4"),
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line10"),
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line14"),
            "Congrats, you are on your machine.",
        )
        self.assertEqual(self.get_text("knowledge_base_line3_tab_header1"), "Tip 1")
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line15"),
            "To change password of root user do sudo passwd root",
        )
        self.assertTrue(self.wait_element("knowledge_base_line3_tab_image14"))
        self.assertEqual(self.get_text("knowledge_base_line3_tab_header2"), "Tip 2")
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line16"),
            "To connect over ssh you always need to login as cloudscalers and then "
            "use sudo -s to get root access.",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line3_tab_line17"),
    ...
    def test05_technical_tutorials_forth_tab(self):
        ...
        **Test Scenario:**
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line4_tab_header"),
            "Enable Root access on ubuntu over SSH",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line4_tab_line1"),
            "Create new password for root",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line4_tab_line2"),
            "Enabling root login from ssh config (default is to deny root access)",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line4_tab_line3"), "Restarting ssh:"
        )
        self.lg("%s ENDED" % self._testID)
    ...
    def test06_technical_tutorials_fifth_tab(self):
        ...
        **Test Scenario:**
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_header"), "My First Machine Windows"
        )
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line1"),
            "Login to the OpenvCloud User Portal:",
        )
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line3"),
            "Select your properties in this example:",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line3_sub1"),
            "Windows 2012r2 Standard",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line3_sub2"),
            "1 GB memory, 1 core(s)",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line3_sub3"),
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line4"),
            "Within seconds the machine is active.",
        )
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line5"),
            "Unlike other clouds, OpenvCloud puts every virtual machine "
            "behind a private firewall.",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line6"),
            "To have access to your virtual machine you can create a VPN "
            "connection (see other tutorials) or configure a",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line7"),
            "port forwarding (means forward a port from your private firewall "
            "to the port on your virtual machine).",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line8"),
            "Here we will choose for the later option.",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line9"),
            "In order to configure the port forwarding, click on Port Forwards tab:",
        )
        self.assertTrue(self.wait_element("knowledge_base_line5_tab_image7"))
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line10"),
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line11"),
            "As a result you will see the below:",
        )
        self.assertTrue(self.wait_element("knowledge_base_line5_tab_image9"))
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line12"), "On your Windows open"
        )
        self.assertTrue(self.wait_element("knowledge_base_line5_tab_image10"))
        self.assertEqual(
            self.get_text("knowledge_base_line5_tab_line13"),
    ...
    def test07_technical_tutorials_sixth_tab(self):
        ...
        **Test Scenario:**
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line6_tab_line8"),
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line6_tab_line9"),
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line6_tab_line10"),
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line6_tab_line15"),
            "In this case you see that the Windows client did receive IP address "
            "192.168.103.244.",
        )
        self.assertEqual(
            self.get_text("knowledge_base_line6_tab_line16"),
    ...
    def test08_technical_tutorials_seventh_tab(self):
        ...
        **Test Scenario:**
        ...
        self.assertEqual(
            self.get_text("knowledge_base_line7_tab_header"), "Using the API"
        )
