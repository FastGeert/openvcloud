...
class Machines:
    ...
    def addUser(self, machineId, userId, accesstype="ARCXDU"):
        return self._api.cloudapi.machines.addUser(
            machineId=machineId, userId=userId, accesstype=accesstype
        )
    ...
    def clone(self, machineId, **kwargs):
        ...
        return self._api.cloudapi.machines.clone(
            machineId=machineId, name=name, **kwargs
        )
    ...
    def convertToTemplate(self, machineId, **kwargs):
        ...
        return self._api.cloudapi.machines.convertToTemplate(
            machineId=machineId, templatename=templatename
        )
    ...
    def deleteUser(self, machineId, userId):
        return self._api.cloudapi.machines.deleteUser(
            machineId=machineId, userId=userId
        )

    def detachDisk(self, machineId, diskId):
        return self._api.cloudapi.machines.deletedetachDiskUser(
            machineId=machineId, userId=userId
        )
    ...
    def rollbackSnapshot(self, machineId, **kwargs):
        return self._api.cloudapi.machines.rollbackSnapshot(
            machineId=machineId, **kwargs
        )

    def snapshot(self, machineId):
        data = {"machineId": machineId, "name": utils.random_string()}
        data.update(**kwargs)
