...
class Portforwarding:
    ...
    def list(self, cloudspaceId, **kwargs):
        return self._api.cloudapi.portforwarding.list(
            cloudspaceId=cloudspaceId, **kwargs
        )
    ...
    def delete(self, cloudspaceId, id):
        return self._api.cloudapi.portforwarding.delete(
            cloudspaceId=cloudspaceId, id=id
        )
